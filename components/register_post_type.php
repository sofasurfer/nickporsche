...
class PostTypes {
    ...
    public function register_post_type($name, $icon, $labels, $rewrite, $tags=false, $categories=false, $supports=['title', 'excerpt', 'thumbnail', 'revisions', 'page-attributes', 'editor']) {
        if($rewrite) {
