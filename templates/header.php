...
<head>
    ...
    <link rel="manifest" href="<?= get_stylesheet_directory_uri(); ?>/assets/images/site.webmanifest">
    <link rel="mask-icon" href="<?= get_stylesheet_directory_uri(); ?>/assets/images/safari-pinned-tab.svg" color="#5bbad5">
